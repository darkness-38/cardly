    ...
    return (
        <div className="min-h-screen bg-[#bfbfbf] dark:bg-[#191919] text-[#2d2d2d] dark:text-[#e5e5e5] font-sans transition-colors duration-300">
            <div className="min-h-screen flex flex-col items-center justify-center p-6 md:p-12 overflow-x-hidden">
                ...
                {/* Stats Section */}
                <div className="flex items-center gap-8 text-[#525252] dark:text-[#a3a3a3]">
                    <div className="flex flex-col items-center">
                        <span className="text-xl font-bold text-[#2d2d2d] dark:text-[#e5e5e5]">{user?.followersCount || 0}</span>
                        <span className="text-xs font-semibold uppercase tracking-wider opacity-60">Followers</span>
                    </div>
                    <div className="w-px h-8 bg-[#969696]/20 dark:bg-[#000000]/20"></div>
                    <div className="flex flex-col items-center">
                        <span className="text-xl font-bold text-[#2d2d2d] dark:text-[#e5e5e5]">{user?.followingCount || 0}</span>
                        <span className="text-xs font-semibold uppercase tracking-wider opacity-60">Following</span>
                    </div>
                </div>
